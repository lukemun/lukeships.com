  ...
  return (
    <div style={{ minHeight: "100vh", background: "#0B0F1A", color: "#E2E8F0", fontFamily: "'DM Sans', sans-serif", padding: "40px 20px", display: "flex", flexDirection: "column", alignItems: "center" }}>
      ...
      <div style={{ maxWidth: 720, width: "100%", marginBottom: 28 }}>
        <div style={{ fontFamily: "'JetBrains Mono', monospace", fontSize: 11, color: "#64748B", letterSpacing: "0.12em", textTransform: "uppercase", marginBottom: 8 }}>Strength 07 / 07</div>
      ...
      {/* Dimensions */}
      <div style={{ maxWidth: 720, width: "100%", marginBottom: 20, display: "flex", gap: 8, flexWrap: "wrap" }}>
        {DIMENSIONS.map((d) => (
          <div key={d.id} style={{ flex: "1 1 140px", padding: "10px 12px", background: "rgba(15,22,41,0.5)", border: "1px solid rgba(148,163,184,0.06)", borderRadius: 8 }}>
            <div style={{ fontFamily: "'JetBrains Mono'", fontSize: 9, color: "#475569", letterSpacing: "0.1em", textTransform: "uppercase", marginBottom: 6 }}>{d.label}</div>
            <div style={{ display: "flex", flexWrap: "wrap", gap: 4 }}>
              {d.options.map((o, i) => (
                <span key={i} style={{ fontFamily: "'DM Sans'", fontSize: 10, color: "#94A3B8", padding: "2px 6px", background: "rgba(148,163,184,0.06)", borderRadius: 3 }}>{o}</span>
              ))}
            </div>
          </div>
        ))}
      ...
      <div style={{ maxWidth: 720, width: "100%", marginBottom: 16 }}>
        <div style={{ background: "linear-gradient(180deg, #0F1629, #131B2E)", borderRadius: 14, border: "1px solid rgba(148,163,184,0.08)", padding: "20px 24px", boxShadow: "0 4px 40px rgba(0,0,0,0.4)" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 16 }}>
            <div style={{ fontFamily: "'JetBrains Mono'", fontSize: 10, color: "#475569", letterSpacing: "0.1em", textTransform: "uppercase" }}>
            ...
            {visibleCount < 10 && (
              <button onClick={addMore} style={{
                ...
                borderRadius: 6, cursor: "pointer", fontFamily: "'JetBrains Mono'", fontSize: 10, color: "#3B82F6",
            ...
            return (
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: isHovered ? 6 : 0 }}>
                  <span style={{ fontFamily: "'JetBrains Mono'", fontSize: 10, color: "#475569", minWidth: 14 }}>#{i + 1}</span>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                    ...
                    <span style={{ fontFamily: "'JetBrains Mono'", fontSize: 9, color: tier.color, letterSpacing: "0.05em", minWidth: 50 }}>{tier.label}</span>
                  </div>
                </div>
                {isHovered && (
                  <div style={{ marginLeft: 24, fontSize: 11.5, color: "#64748B", lineHeight: 1.5, fontFamily: "'DM Sans'" }}>
                    {h.note}
                    <div style={{ marginTop: 4, display: "flex", gap: 4 }}>
                      {DIMENSIONS.map((d, di) => (
                        <span key={di} style={{ fontSize: 9, fontFamily: "'JetBrains Mono'", padding: "1px 5px", background: "rgba(148,163,184,0.06)", borderRadius: 3, color: "#94A3B8" }}>
          ...
          {visibleCount >= 7 && (
            <div style={{ marginTop: 12, padding: "12px 16px", background: "rgba(16,185,129,0.04)", border: "1px solid rgba(16,185,129,0.12)", borderRadius: 8 }}>
              <div style={{ fontFamily: "'JetBrains Mono'", fontSize: 10, color: "#10B981", letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: 4 }}>
      ...
      <div style={{ maxWidth: 720, width: "100%", display: "flex", gap: 12, flexWrap: "wrap" }}>
        <div style={{ flex: "1 1 340px", padding: "16px 18px", background: "rgba(232,69,60,0.04)", border: "1px solid rgba(232,69,60,0.12)", borderRadius: 12 }}>
          <div style={{ fontFamily: "'JetBrains Mono'", fontSize: 10, color: "#E8453C", letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: 8 }}>The wrong way</div>
        ...
        <div style={{ flex: "1 1 340px", padding: "16px 18px", background: "rgba(16,185,129,0.04)", border: "1px solid rgba(16,185,129,0.12)", borderRadius: 12 }}>
          <div style={{ fontFamily: "'JetBrains Mono'", fontSize: 10, color: "#10B981", letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: 8 }}>The right way</div>
          <div style={{ fontSize: 13, color: "#94A3B8", lineHeight: 1.65 }}>
